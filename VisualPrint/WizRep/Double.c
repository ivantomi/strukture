...
int DoubleInfo()
{
	printf("Dvostruko vezane liste su one kod kojih svaki element ima pokazivac na prethodni i sljedeci clan.\n");
	printf("Prednost dodatnog pokazivaca je pojednostavljenost brisanja, ali mane su dodatni prostor koji zauzimamo i potreba\n");
	printf("za dodatnim postavljanjem pokazivaca pri dodavanju i brisanju elemenata iz liste.\n\n");
	printf("U programskoj realizaciji Head element pokazuje na prvi element liste i obratno, a zadnji element ima NULL pokazivac na sljedeceg.\n");
	system("pause");
}
